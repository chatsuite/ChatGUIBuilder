/*!
 * chat-gui-builder.js - ChatGUIBuilder JS v1.0.0
 * ---------------------------------------------------------
 * NPM:    npmjs.com/package/chat-gui-builder
 * GitHub: github.com/chatsuite/chat-gui-builder
 * ---------------------------------------------------------
 * Author: Ron Bar ^ Asaf Yannay
 * Email:  ron@chatsuit.com
 * Www:    chatsuite.com
 * GitHub: github.com/chatsuite
 * ---------------------------------------------------------
 * 19 JUL 2018
 */


var ChatGUIBuilder = function () {
...
ChatGUIBuilder.prototype.toString = function () {
	return this.body;
};

ChatGUIBuilder.prototype.parse = function (document) {
...
ChatGUIBuilder.prototype.ele = function (tag, arg2, arg3) {
...
ChatGUIBuilder.prototype.val = function (text) {
	this.body = this.body.concat(text);
	return this;
};

ChatGUIBuilder.prototype.cl = function () {
	this.body = this.body.concat('</'+this.tags.pop()+'>');
	return this;
};

if ( typeof module === "object" && typeof module.exports === "object" ) {
	module.exports = ChatGUIBuilder;
}
